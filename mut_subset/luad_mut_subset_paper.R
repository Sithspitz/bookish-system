...
#for(i in levels(Intermediate$Patient.ID)){ 
  ...
  work$Hugo_Symbol <- as.factor(work$Hugo_Symbol)
  output[c, "Patient.ID"] <- i
  output[c, "Mutation_Status"] <- ifelse((length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "EGFR"])) != 0 &
                                            length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "KRAS"])) == 0 &
                                                     length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "STK11"])) == 0 &
                                                              length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "TP53"])) == 0), "EGFR_Mut",
                                                                     ifelse((length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "EGFR"])) == 0 &
                                                                       length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "KRAS"])) != 0 &
                                                                                length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "STK11"])) == 0 &
                                                                                         length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "TP53"])) == 0), "KRAS_Mut",
                                                                                                ifelse((length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "EGFR"])) == 0 &
                                                                                                  length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "KRAS"])) == 0 &
                                                                                                           length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "STK11"])) != 0 &
                                                                                                                    length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "TP53"])) == 0), "STK11_Mut",
                                                                                                                           ifelse((length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "EGFR"])) == 0 &
                                                                                                                             length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "KRAS"])) == 0 &
                                                                                                                                      length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "STK11"])) == 0 &
                                                                                                                                               length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "TP53"])) != 0), "TP53_Mut",
                                                                                                                                                      ifelse((length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "EGFR"])) == 0 &
                                                                                                                                                        length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "KRAS"])) != 0 &
                                                                                                                                                                 length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "STK11"])) != 0 &
                                                                                                                                                                          length(is.na(levels(work$Hugo_Symbol)[levels(work$Hugo_Symbol) %in% "TP53"])) == 0), "Double_Mut", "Other_Mut")))
                                                                                                                                                                              c <- c + 1}
